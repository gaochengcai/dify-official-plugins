...
# Dify Gemini Custom Plugin Packaging Script
# This script packages the gemini_custom plugin into a .difypkg file
...
PACKAGE_NAME="gemini_custom.difypkg"

echo "Packaging Gemini Custom Plugin v${OLD_VERSION} -> v${VERSION}..."
...
echo "2. Check logs: docker compose exec plugin_daemon cat /tmp/gemini_custom.log"
